...
Read the matrix size n and input the two square matrices A and B.
Divide both matrices into four equal submatrices recursively.
Use Strassen’s algorithm to compute the seven matrix products and combine them to form the resulting matrix.
Display the final multiplied matrix as the output.   
...
## Output:
<img width="893" height="297" alt="image" src="https://github.com/user-attachments/assets/5b9ad6be-651c-4993-9c06-4e37b3d64269" />
